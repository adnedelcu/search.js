...
var VisualSearch = (function($, _){
        ...
        inputkeydown: function(e){
            var self = this,
                editNext = function(){
                    ...
                    if( editing===2 ){
                        index = self.searchQuery.indexOf(selected);
    ...
    VS.template =
    {
        'search_box' : _.template('<div class="VS-search-box-wrapper VS-search-box input-group">\n    <span class="input-group-addon"><i class="fa fa-search"></i></span>\n    <div class="VS-placeholder form-control"><%= placeholder %></div>\n    <div class="VS-search-inner"></div>\n    <span class="VS-cancel-search-box input-group-addon" title="clear search"><i class="fa fa-ban"></i></span>\n  </div>'),
        // 'search_box': _.template('<div class="VS-search">\n  <div class="VS-search-box-wrapper VS-search-box">\n    <div class="VS-icon VS-icon-search fa fa-search"></div>\n    <div class="VS-placeholder"><%= placeholder %></div>\n    <div class="VS-search-inner"></div>\n    <div class="VS-icon VS-icon-cancel VS-cancel-search-box fa fa-ban" title="clear search"></div>\n  </div>\n</div>'),
        'search_parameter': _.template('<span class="search_parameter_remove"><i class="fa fa-ban"></i></span><div class="key"><%= model.get(\'key\') %></div><div class="operator"><%= model.get(\'operator\') %></div><div class="value"><%= model.get(\'value\') %></div>')
    };
    ...
    VS.ParameterView = Backbone.View.extend({
        ...
        events : {
            ...
            'click'         : 'click',
            'click span.search_parameter_remove': 'delete',
            ...
            this.operator = {
                ...
                autocomplete: {
                    ...
                    source: function(req, res){
                        ...
                        if(parameters.operators && parameters.operators[i]){
